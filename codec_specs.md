...
Type Description: the `BlockAddIDExtraData` data is interpreted as `AVCDecoderConfigurationRecord` structure for the enhancement layer as defined in [@!ISO.14496-15.2014], as described in [@!DolbyVisionWithinIso.2020-02]. This extension MUST NOT be used if `Codec ID` is not `V_MPEG4/ISO/AVC`.
...
Type Description: the `BlockAddIDExtraData` data is interpreted as `HEVCDecoderConfigurationRecord` structure for the enhancement layer as defined in [@!ISO.14496-15.2014], as described in [@!DolbyVisionWithinIso.2020-02]. This extension MUST NOT be used if `Codec ID` is not `V_MPEGH/ISO/HEVC`.
